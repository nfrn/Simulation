...
public class LifeBar extends BasicProgressBarUI {
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        g2d.setColor(new Color(0x2F4F4F));
        g2d.setBackground(new Color(0x2F4F4F));
        ...
        Color[] colors = {new Color(0x800000), new Color(0x800000).brighter(), new Color(0x800000).darker()};
